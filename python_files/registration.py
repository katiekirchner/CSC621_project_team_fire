...
def save_plot(registration_method, fixed, moving, transform, file_name_prefix):
    ...
    write_combined_image(combined_slices_image, plot_image, 20,
...
if __name__ == '__main__':
    # Read the images
    fixed_image = sitk.ReadImage("test/test.nrrd", sitk.sitkFloat32)
    moving_image = sitk.ReadImage("test/test.nrrd", sitk.sitkFloat32)
